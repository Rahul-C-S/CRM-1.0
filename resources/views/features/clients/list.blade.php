...
<style>
    #searchResults{ text-align: center; font-size:20px; border: 1px solid black; position: absolute; z-index: 2; background: white; display: block; width: max-content; left: 150px; margin-top: 15px; }
